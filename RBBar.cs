    ...
    static class Rainbow
    {
        ...
        public static LinearGradientBrush RainbowBrush(Point point1, Point point2)
        {
            ...
            color_blend.Colors = new Color[]
                { Color.FromArgb(54, 40, 135), Color.FromArgb(71, 25, 122), Color.FromArgb(80, 33, 113), Color.FromArgb(93, 30, 101),
                  Color.FromArgb(99, 32, 97), Color.FromArgb(115, 42, 100), Color.FromArgb(125, 22, 95) };
        ...
        public static LinearGradientBrush RainbowBrush2(Point point1, Point point2)
        {
            LinearGradientBrush rainbow_brush2 =
                new LinearGradientBrush(point1, point2,
                    Color.Red, Color.Red);
            ...
            ColorBlend color_blend = new ColorBlend();
            color_blend.Colors = new Color[]
                { Color.FromArgb(125, 22, 95), Color.FromArgb(54, 40, 135),Color.FromArgb(71, 25, 122), Color.FromArgb(80, 33, 113), Color.FromArgb(93, 30, 101),Color.FromArgb(99, 32, 97), Color.FromArgb(115, 42, 100) };
            color_blend.Positions = new float[] { 0, 1 / 6f, 2 / 6f, 3 / 6f, 4 / 6f, 5 / 6f, 1 };
            rainbow_brush2.InterpolationColors = color_blend;

            return rainbow_brush2;
        }
